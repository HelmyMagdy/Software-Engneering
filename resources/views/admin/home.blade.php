                ...
                <div id="navbar" class="navbar-collapse collapse text-center">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown ">
                            ...
                            <a href="index.admin.html">Home</a>
                        </li>
                            ...
                            <div class="dropdown-menu">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-sm-3">
                                        <ul>
                                            <li class="dropdown-header">Products Options</li>
                                            <li role="separator" class="divider"></li>
                                            <li><a href="product.view.admin.html">View product</a></li>
                                            <li><a href="addproduct.admin.html">Add product</a></li>
                                            <li><a href="editproduct.admin.html">Edit product</a></li>
                                            <li><a href="deleteproduct.admin.html">Delete product</a></li>
                        ...
                        <li class="dropdown dropdown-slide">
                            <a href="#!" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                                data-delay="350" role="button" aria-haspopup="true" aria-expanded="false">Orders<span
                                    class="tf-ion-ios-arrow-down"></span></a>
                            <div class="dropdown-menu">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-sm-3">
                                        <ul>
                                            <li class="dropdown-header">Order Options</li>
                                            <li role="separator" class="divider"></li>

                                            <li><a href="vieworder.admin.html">View Order</a></li>
                                            <li><a href="deleteorder.admin.html">Delete Order</a></li>
                                            <li><a href="order.html">Trace Order</a></li>
                                        </ul>
                                    </div>
                        ...
                        <li class="dropdown dropdown-slide">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="profile-details.html">View profile</a></li>
                                <li><a href="editinfo.admin.html">Edit profile</a></li>
