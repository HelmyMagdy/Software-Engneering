    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 text-center">
          ...
          <h1 data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".5">Your personal hygiene health
			   <br> is our responsibility</h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 text-right">
           <h1 data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".5">Always be care about yourself
			    <br> and we will help you</h1>
          <a data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn" href="shop.html">Shop Now</a>
        </div>
      </div>
    </div>
